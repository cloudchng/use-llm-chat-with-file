...
class DocChat(param.Parameterized):
    ...
    def __init__(self,  **params):
        ...
        self.change_llm(REPO, MODEL, max_tokens=4096, temperature=0.2, top_p=0.95, top_k=50, repeat_penalty=1.2, k=3)
    ...
    def change_llm(self, repo_, file_, max_tokens=4096, temperature=0.2, top_p=0.95, top_k=50, repeat_penalty=1.2, k=3):
